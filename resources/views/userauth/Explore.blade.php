    ...
    <div class="page">
        <div class="side-panel">
            <form action="apply_filters" method="POST">
                @csrf
                <h2>Filters</h2>
                <label for="price-range">Price:</label><span class="price_max" id="price"></span>
                <input type="range" class="price_range" id="myRange" name="maxprice" min="100000" value="50000000" max="100000000">
