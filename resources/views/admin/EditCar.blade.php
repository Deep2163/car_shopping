            ...
            <div class="col-sm-5 center">
                <form action="Update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                        <label>Company:</label>
                        <input type="text" name="company" id="company" class="form-control" value="{{ old('company',$car->company)}}"/>
                        </div>
                    ...
                    <div class="form-group">
                        <label>Model:</label>
                        <input type="text" name="carmodel" id="carmodel" class="form-control"value="{{ old('carmodel',$car->carmodel)}}"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <Textarea name="description" id="description" class="form-control">{{ old('description',$car->description)}}
                        </Textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="number" min="1900" max="2024" step="1" value="2024,{{$car->year}}" name="year"/>
                    </div>
                    @if($errors->has('year'))
                    ...
                    <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="number" min="1" max="1000" step="1" value="1,{{$car->stock}}" name="stock"/>
                    </div>
                    @if($errors->has('stock'))
                    ...
                    <div class="form-group">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;
                        <input type="number" min="100000" max="3000000000" name="price" value="{{ old('price',$car->price)}}"/>
                    </div>
                    @if($errors->has('price'))
